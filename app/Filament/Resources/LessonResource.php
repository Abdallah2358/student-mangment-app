        ...
        return $form
            ->schema([
                Grid::make()->schema([
                    ...
                    TextInput::make('tajwed_rule')->label('نظري')->nullable(),
                ])->columnSpanFull(),
                Accordions::make('')->isolated()
                    ->activeAccordion(0)
                    ->columnSpanFull()
                    ->accordions([
                        Accordion::make('خيارات متقدمة')
                            ->schema([
                                Tabs::make()
                                    ->tabs(
                                        [
                                            Tab::make('القراءة')->schema([
